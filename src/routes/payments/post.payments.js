    ...
    try {
        ...
        if(doctor) {
            ...
            let preference = {
                ...
                back_urls: {
                    "success": `${process.env.BACKEND_URL}/payments/feedback?doctor=${user_email}&user=${tutor_email}&startDateTime=${startDateTime}&endDateTime=${endDateTime}&symptoms=${idsSimptoms}&patient=${patient}`,
